...
class ScanOperation : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_number_of_files() const;
  inline void clear_number_of_files();
  static const int kNumberOfFilesFieldNumber = 3;
 ...
 private:
  ...
  ::google::protobuf::int32 number_of_files_;
...
// required int32 number_of_files = 3;
inline bool ScanOperation::has_number_of_files() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ScanOperation::set_has_number_of_files() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ScanOperation::clear_has_number_of_files() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ScanOperation::clear_number_of_files() {
  number_of_files_ = 0;
  clear_has_number_of_files();
}
inline ::google::protobuf::int32 ScanOperation::number_of_files() const {
  return number_of_files_;
}
inline void ScanOperation::set_number_of_files(::google::protobuf::int32 value) {
  set_has_number_of_files();
  number_of_files_ = value;
}
